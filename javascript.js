...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (companyMailEl) {
    companyMailEl.href = `mailto:lukywahyu74@gmail.com`;
  ...
  if (waWebDev) {
    waWebDev.href = `https://api.whatsapp.com/resolve/?deeplink=%2F%24%257Bhttps%3A%2F%2Fwa.me%2Fqr%2F4LTL6PT44ZMZF1%257D%3Ftext%3DHalo%2BSadaharu.id%252C%2Bsaya%2Btertarik%2Bdengan%2Blayanan%2BCustom%2BWeb%2BDevelopment.%2BBisa%2Btolong%2Bjelaskan%2Bprosedurnya%253F&not_found=1?text=Halo%20Sadaharu.id%2C%20saya%20tertarik%20dengan%20layanan%20Custom%20Web%20Development.%20Bisa%20tolong%20jelaskan%20prosedurnya%3F`;
  }

  const waAppDev = document.getElementById("wa-btn-app-dev");
  if (waAppDev) {
    waAppDev.href = `https://api.whatsapp.com/resolve/?deeplink=%2F%24%257Bhttps%3A%2F%2Fwa.me%2Fqr%2F4LTL6PT44ZMZF1%257D%3Ftext%3DHalo%2BSadaharu.id%252C%2Bsaya%2Btertarik%2Bdengan%2Blayanan%2BCustom%2BWeb%2BDevelopment.%2BBisa%2Btolong%2Bjelaskan%2Bprosedurnya%253F&not_found=1?text=Halo%20Sadaharu.id%2C%20saya%20tertarik%20dengan%20layanan%20Mobile%20App%20Engineering.%20Bisa%20tolong%20jelaskan%20prosedurnya%3F`;
  }

  const waUiux = document.getElementById("wa-btn-uiux-design");
  if (waUiux) {
    waUiux.href = `https://api.whatsapp.com/resolve/?deeplink=%2F%24%257Bhttps%3A%2F%2Fwa.me%2Fqr%2F4LTL6PT44ZMZF1%257D%3Ftext%3DHalo%2BSadaharu.id%252C%2Bsaya%2Btertarik%2Bdengan%2Blayanan%2BCustom%2BWeb%2BDevelopment.%2BBisa%2Btolong%2Bjelaskan%2Bprosedurnya%253F&not_found=1?text=Halo%20Sadaharu.id%2C%20saya%20tertarik%20dengan%20layanan%20Premium%20UI%2FUX%20Design.%20Bisa%20tolong%20jelaskan%20prosedurnya%3F`;
  }

  // Setting Link Tombol WhatsApp Kemitraan Pribadi
  const waPartnerDev = document.getElementById("wa-partner-developer");
  if (waPartnerDev) {
    waPartnerDev.href = `https://api.whatsapp.com/resolve/?deeplink=%2F%24%257Bhttps%3A%2F%2Fwa.me%2Fqr%2F4LTL6PT44ZMZF1%257D%3Ftext%3DHalo%2BSadaharu.id%252C%2Bsaya%2Btertarik%2Bdengan%2Blayanan%2BCustom%2BWeb%2BDevelopment.%2BBisa%2Btolong%2Bjelaskan%2Bprosedurnya%253F&not_found=1?text=Halo%20Sadaharu.id%2C%20saya%20tertarik%20untuk%20bergabung%20sebagai%20mitra%20Asisten%20Developer.%20Bagaimana%20langkah%20selanjutnya%3F`;
  }

  const waPartnerReseller = document.getElementById("wa-partner-reseller");
  if (waPartnerReseller) {
    waPartnerReseller.href = `https://api.whatsapp.com/resolve/?deeplink=%2F%24%257Bhttps%3A%2F%2Fwa.me%2Fqr%2F4LTL6PT44ZMZF1%257D%3Ftext%3DHalo%2BSadaharu.id%252C%2Bsaya%2Btertarik%2Bdengan%2Blayanan%2BCustom%2BWeb%2BDevelopment.%2BBisa%2Btolong%2Bjelaskan%2Bprosedurnya%253F&not_found=1?text=Halo%20Sadaharu.id%2C%20saya%20tertarik%20untuk%20bergabung%20sebagai%20mitra%20Reseller%20Resmi.%20Bagaimana%20langkah%20selanjutnya%3F`;
  }
...
function handleFormSubmit(formElement, type, notifBoxId) {
  // Kirim form kemitraan langsung ke email (tanpa perlu Apps Script)
  if (type === "kerjasama") {
    ...
    const emailBody = encodeURIComponent(
      [
        ...
        `Telepon/WhatsApp: ${payload.telepon || payload.telepon || payload.telepon || "-"}`,
        `Pesan: ${payload.pesan || "-"}`,
      ].join("\n"),
    );

    // Buka email client pengguna dengan isi otomatis
    window.location.href = `mailto:${COMPANY_EMAIL}?subject=${emailSubject}&body=${emailBody}`;

    // Tampilkan notifikasi sukses UI
